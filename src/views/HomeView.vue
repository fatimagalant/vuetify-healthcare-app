...
<v-chip class="ma-2" color="white">
  ...
  <v-col cols="12" sm="12">
    <v-card class="mx-12 rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl mt-n15">
      <v-list-item three-line>
        ...
        <v-list-item-avatar title size="150" class="pr10">
  ...
  <v-col cols="12" sm="6">
    <v-card class="mx-12 rouned-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl mt-n4" color="teal" dark>
      <v-list-item three-line>
  ...
  <v-col cols="12" sm="6">
    <v-card class="mx-12 rouned-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl mt-n12">
<v-app-bar color="rgba(0,0,0,0)" flat class="ma-8">
  <h5>Your activity</h5>
  <v-spacer></v-spacer>
...
<v-row>
  <v-col cols="12" sm="12">
    <v-list two-line>
      <v-list-item>
        <v-list-item-avatar>
          <img src="https://i.postimg.cc/NGXST85g/christopher-campbell-r-DEOVt-E7v-Os-unsplash-1.jpg">
        </v-list-item-avatar>
        <v-list-item-content>
          <v-list-item-title>Chloe Smith</v-list-item-title>
  ...
  <v-col cols="12" md="4">
    <v-row>
      <v-col cols="12" md="2">
        <v-card height="50px" width="4px" color="green"></v-card>
      </v-col>
      <v-col cols="12" md="5">
  ...
  <v-col cols="12" md="4">
    <v-row>
      <v-col cols="12" md="2">
        <v-card height="50px" width="3px" color="red"></v-card>
      </v-col>
      <v-col cols="12" md="5">
        <v-list two-line subheader class="ml-n4">
          <v-list-item-content>
            <v-list-item-subtitle>Height</v-list-item-subtitle>
            <v-list-item-title>>177 cm+</v-list-item-title>
          </v-list-item-content>
        </v-list>
      </v-col>
    </v-row>
  ...
  <v-col cols="12" md="4">
    <v-row>
      <v-col cols="12" md="2">
        <v-card height="50px" width="3px" color="grey"></v-card>
      </v-col>
      <v-col cols="12" md="5">
        <v-list two-line subheader class="ml-n8">
          <v-list-item>
            <v-list-item-content>
              ...
              <v-list-item-title>>57 kg</v-list-item-title>
            </v-list-item-content>
          </v-list-item>
        </v-list>
  </v-col>
      ...
      <v-col cols="12" sm="12">
        ...
        <v-list-item>
          ...
          <v-list-item-content>
            <v-btn class="mr-1" outlined color="teal darken-1">SU</v-btn>
          </v-list-item-content>
        </v-list-item>
        </v-list>
      </v-col>
...
<v-col cols="12" sm="12">
 <v-card class="mx-12 rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl mt-n4" color="teal lighten-5" flat>
  <v-list-item three-line>
    <v-list-item-avatar title-size="30">
